...
class Contact extends Component {
    ...
    handleSubmit(values) {
        this.props.postFeedback(values.firstname, values.lastname, values.telnum, values.email, values.agree, values.contactType, values.message).then(
            response => { 
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" id="telnum" name="telnum"
                                        ...
                                        className="form-control"
                                        validators={{
                                            required, minLength: minLength(3), maxLength: maxLength(20), isPhoneNumber
                                        }}
                                         />
                                    <Errors
                                        className="text-danger"
                                        ...
                                        messages={{
                                            ...
                                            isPhoneNumber: 'Tel. Number should mantain the form: +390000000000'
                                        }}
                                     />
                                </Col>
                            </Row>
